...
#file='../user-files/resources/wc_d78_1900_2200_mirror.csv'
simulation='ComputerDatabaseSimulationOpoCat'
...
sleep 80
./gatling.sh -s ${simulation} -rm local -rd "wc_d78_1737_2137" #&
...
#start gatling
  ./gatling.sh -s ${simulation} -rm local -rd "WC_start_50_12k" #&
done
