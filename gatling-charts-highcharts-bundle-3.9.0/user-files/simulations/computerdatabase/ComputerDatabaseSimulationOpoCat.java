 ...
 * </ul>
 */
public class ComputerDatabaseSimulationOpoCat extends Simulation {

  int WARMUP_STEP_TIME = 70;
  int WARMUP_STEP_RPS = 20;
...
ScenarioBuilder scn = scenario("BasicSimulation") // 7
  .exec(http("reque") // 8
      ...
      .queryParam("size_to",   "3000000") // 3m-Median 160ms, Max 240, 50+ RPS
      .queryParam("sleep_from", "50")
      .queryParam("sleep_to", "100")); // 9
// .pause(5); // 10

  public ComputerDatabaseSimulationOpoCat() throws Exception {
    ...
    // double devidor = 1; //used for Demo1 tests  in saa and cat 6x20
    double devidor = 1; //used for 
