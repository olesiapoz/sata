 ...
 * </ul>
 */
public class SwitchOnOffSimulation extends Simulation {

  int PERIOD_STEP_TIME = 45;
  int MIN_STEP_RPS = 0; 
  int MAX_STEP_RPS = 125;
  int STEP_RUMPUP_TIME = 2;
  int RPS_HOLD_TIME = PERIOD_STEP_TIME - STEP_RUMPUP_TIME;
  int EXPEREMENT_LENGTH_SECONDS = 130*90;//140 OFF WC-Perc, 126-saa, 130-avg
  ...
  public SwitchOnOffSimulation() throws Exception {
