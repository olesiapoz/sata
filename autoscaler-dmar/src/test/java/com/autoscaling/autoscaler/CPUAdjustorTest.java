...
class CPUAdjustorTest {
    ...
    public void shouldReachMaxValues() {
        ...
        assertEquals(0.85, cpuSettings.getUpscalingValues().getUpper());
        assertEquals(0.75, cpuSettings.getUpscalingValues().getMid());
        assertEquals( 0.55, cpuSettings.getUpscalingValues().getLower());
    ...
    public void shouldReachMinValues() {
        ...
        assertEquals(0.55, cpuSettings.getUpscalingValues().getUpper());
        assertEquals(0.45, cpuSettings.getUpscalingValues().getMid());
        assertEquals( 0.35, cpuSettings.getUpscalingValues().getLower());
