...
public class CPUAdjustor {
    ...
    private static final double UPSCALING_UPPER_MIN = 0.55; //under norm
    private static final double UPSCALING_MID_MIN = 0.45;
    public static final double UPSCALING_LOWER_MIN = 0.35;

    public static final double UPSCALING_UPPER_MAX = 0.95; //norm
    private static final double UPSCALING_MID_MAX = 0.75;
    private static final double UPSCALING_LOWER_MAX = 0.55;

    public static final double DOWNSCALING_UPPER_MIN = 0.30;
    public static final double DOWNSCALING_MID_MIN = 0.20;
    public static final double DOWNSCALING_LOWER_MIN = 0.15; //under norm

    public static final double DOWNSCALING_UPPER_MAX = 0.49;
    public static final double DOWNSCALING_MID_MAX = 0.40;
    public static final double DOWNSCALING_LOWER_MAX = 0.30; // norn

    private static final Integer ADJUSTMENT_INTERVAL_IN_SECONDS = 9 * 60;
