...
public class DMScalingService {
    ...
    private static final double CPU_THRESHOLD = 75;
    private static final double RESPONSE_TIME_THRESHOLD = 0.13;
    ...
    private boolean isTimeToScale() {
        ...
        Timestamp then = DateUtils.fromDate(lastTimeChecked, Calendar.SECOND, 90);
