...
public class FileWriter {
    ...
    public void writeAll(AvgCPU avgCPU, BTCount btCount, PodCount podCount, SLA sla, PodUpTime podUpTime, BTTotal btTotal,  AvgResponse avgResponse, TouchstonePodCount touchStonePods) {
        avgCPUWriter.println(avgCPU.toCSVLine()+","+btCount.toCSVLine()+","+podCount.toCSVLine()+","+sla.toCSVLine()+","+podUpTime.toCSVLine()+","+btTotal.toCSVLine()+","+avgResponse.toCSVLine()+","+touchStonePods.toCSVLine());
        avgCPUWriter.flush();
    }
