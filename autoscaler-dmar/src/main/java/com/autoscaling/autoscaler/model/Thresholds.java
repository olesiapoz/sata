...
public class Thresholds {
    ...
    //public Thresholds(Double percentileResponse, Double avgResponse, Double avgCPU,  Double throughput, Integer  podCount) {
    public Thresholds( Double avgCPU,  Double throughput) {
