...
public class Velocity {
    ...
    public static final int MAX_THROUGHPUT_VALUE = 27;
    public static final int TOLERABLE_TIME_PER_SINGLE_REPLICA = 55;

    {
        ...
        BigDecimal totalTimeDecrease = BigDecimal.valueOf(ScalingService.MAX_REPLICAS)
                .subtract(BigDecimal.valueOf(ScalingService.MIN_REPLICAS))
                .multiply(BigDecimal.valueOf(TOLERABLE_TIME_PER_SINGLE_REPLICA-1));
    ...
    public Velocity(Double currentVelocity, Integer currentReplicas) {
        ...
        if (this.currentVelocity >= 0) {
            increaseFactor = (int)Math.ceil(BigDecimal.valueOf(Math.abs(this.currentVelocity))
                                    .divide(BigDecimal.valueOf(ScalingService.MAX_REPLICAS).subtract(BigDecimal.valueOf(currentReplicas-1)), 2, RoundingMode.HALF_UP)
