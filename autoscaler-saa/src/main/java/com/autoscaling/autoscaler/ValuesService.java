...
public class ValuesService {
    ...
    private final AtomicReference<AvgResponse> percentileResponseHolder = new AtomicReference<>();
    ...
    private final AtomicReference<Throughput> throughputBench = new AtomicReference<>();
    private final AtomicReference<AvgCPU> suggestedThreshold = new AtomicReference<>();
    private final AtomicReference<Boolean> sufficientNumberOfEventsCollectedflag = new AtomicReference<>();
    ...
    public synchronized void publishLastThreshold(AvgCPU avgCpu) {
        suggestedThreshold.set(avgCpu);
    }

    public synchronized AvgCPU getLastThreshold() {
        return suggestedThreshold.get();
    }
    ...
    public synchronized void publishPercentileResponse(AvgResponse percentileResponse) {
        percentileResponseHolder.set(percentileResponse);
    }

    public synchronized AvgResponse getPercentileResponse() {
        return percentileResponseHolder.get();
    }
    ...
    public synchronized void publishThroughputBench(Throughput throughput) {
        throughputBench.set(throughput);
    }

    public synchronized Throughput getThroughputBench() {
        return throughputBench.get();
    }
    ...
    public synchronized void setSufficientNumberOfEventsCollectedFlag(Boolean lastSlaValue) {
        sufficientNumberOfEventsCollectedflag.set(lastSlaValue);
    }

    public synchronized Boolean getSufficientNumberOfEventsCollectedFlag() {
        return sufficientNumberOfEventsCollectedflag.get();
    }
