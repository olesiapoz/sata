...
public class CPUAdjustor {
    ...
    private static final double UPSCALING_UPPER_MIN = 0.40; //under norm
    private static final double UPSCALING_MID_MIN = 0.30;
    public static final double UPSCALING_LOWER_MIN = 0.22;

    public static final double UPSCALING_UPPER_MAX = 0.75; //norm
    private static final double UPSCALING_MID_MAX = 0.65;
    private static final double UPSCALING_LOWER_MAX = 0.45;

    public static final double DOWNSCALING_UPPER_MIN = 0.15;
    public static final double DOWNSCALING_MID_MIN = 0.12;
    public static final double DOWNSCALING_LOWER_MIN = 0.10; //under norm

    public static final double DOWNSCALING_UPPER_MAX = 0.35;
    public static final double DOWNSCALING_MID_MAX = 0.30;
    public static final double DOWNSCALING_LOWER_MAX = 0.20; // norn
