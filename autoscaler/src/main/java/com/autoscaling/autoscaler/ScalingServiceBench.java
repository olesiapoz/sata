...
public class ScalingServiceBench {
    ...
    private static int trainingSamplesCount = 0;
    private static int underProvisioningPeriodsCount =0;
    private static int thresholdUpdatePeriods = 4;//5-10
    //private static int thresholdUpdatePeriods = 4;//5-10
    ...
    //private static final Integer sufficientEventNumber =  scalePeriod*thresholdEvaluationPeriods/monitoringSamplePeriod >= 150 ? scalePeriod*thresholdEvaluationPeriods/monitoringSamplePeriod : 150;//or min 300 events
                    ...
                    if (!percentileResponse.getValue().isNaN()) {
                       ...
                       if (isTimeToStoreMetricsPeriod(scalePeriod)) {
                           ...
                           if (metrics.size() != 0) {
                               ...
                               if (trainingSamplesCount > 24) {
                                System.out.println("Collected training event number : " + trainingSamplesCount);
