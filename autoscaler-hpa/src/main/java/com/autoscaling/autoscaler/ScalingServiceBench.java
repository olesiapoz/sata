...
public class ScalingServiceBench {
    ...
    private static final Integer sufficientEventNumber =  scalePeriod*thresholdEvaluationPeriods/monitoringSamplePeriod >= 150 ? scalePeriod*thresholdEvaluationPeriods/monitoringSamplePeriod : 150;//or min 150 events
                    ...
                    if (!percentileResponse.getValue().isNaN()) {
                       ...
                       if (isTimeToStoreMetricsPeriod(scalePeriod)) {
                           ...
                           if (metrics.size() != 0) {
                               ...
                               if (trainingSamplesCount > 1.5*thresholdEvaluationPeriods) {
                                ystem.out.println("Training event number : " + trainingSamplesCount);
